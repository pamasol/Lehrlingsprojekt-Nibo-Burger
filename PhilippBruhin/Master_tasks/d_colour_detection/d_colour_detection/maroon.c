...
void maroon_welcome() {
    maroon_mode=0;
    usart_write(MAROON_IMM_CLEAR() MAROON_BRIGHT(0) MAROON_LOAD() "1" MAROON_BAR("0") MAROON_DIM(*) MAROON_PAUSE(100) MAROON_DIM(5) MAROON_STIME(60) " Pamasol Machines for Aerosol and Spray Systems\n" MAROON_TXBACK("."));
}
