...
*NIBO Burger in action. It detects the black line with its surface sensors and controls the motors accordingly. This is an exercise that the trainees have to program.*
